...
from src.Dynamical_systems_utils.LV_Modified.LVM_rmFrac2 import gt_utils,realparame2gtarray,generate_pdf


save_dir_prefix = "LVMfrac2_chk_"

to_plot = [ [0, 1], [0, 2],[0,7],[1, 4],[1,5],[1,7]]
xlabel_list = ["$\\dot{x}$ : $x$",
                "$\\dot{x}$ : $-x^2$",
               "$\\dot{x}$ : $-\\frac{xy}{1+hx}$",
...
plot_dict = {"legend":True, "est_color": "blue", "gt_color": "red", "flat_color":"green","pdf_color":"black",
             ...
             "max_y_limit": 40.3,"plot_name":"plot_LVMfrac2","pdf_fill":False,"xlabel_list":xlabel_list}
