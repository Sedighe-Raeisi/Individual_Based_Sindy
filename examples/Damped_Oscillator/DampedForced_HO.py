...
model = MultiTargetMultiEquation_HSModel #Double_HSModel # #all options: MultiTargetMultiEquation_HSModel, MultiTargetMultiEquation_Normal, Double_HSModel
