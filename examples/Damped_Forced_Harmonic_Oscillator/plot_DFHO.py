...
from src.Dynamical_systems_utils.DampedForced_HO import gt_utils,realparame2gtarray, generate_pdf
from src.plot import plot_check_stationary
import os
root_path = os.getcwd()
# root_path = os.path.join(root_path,"examples")
# root_path = os.path.join(root_path, "Damped_Forced_Harmonic_Oscillator")
# root_path = "C:\\Users\\s\\Downloads\\OsnabrukPostdocProject\\projects\\BH\\physical_system_v4\\examples"

save_dir_prefix = "DFHO_chk_" # Changed prefix for Lotka-Volterra checkpoints
