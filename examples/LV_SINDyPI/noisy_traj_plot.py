...
save_dir_prefix = "LVM_SINDyPI_" # Changed prefix for Lotka-Volterra checkpoints
...
feature_plot(save_path,gt_utils,realparame2gtarray, true_params_file_str,n_ind=4,stop_subplot_n=None,scaler=None) # scaler = "min-max" or "z-score"
