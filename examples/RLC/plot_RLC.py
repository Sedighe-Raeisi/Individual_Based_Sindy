...
from src.Dynamical_systems_utils.RLC import gt_utils,realparame2gtarray, generate_pdf
...
save_dir_prefix = "RLC_chk_" # Changed prefix for Lotka-Volterra checkpoints
