...
def mix_data(system_param_dict):
    ...
    for param_set in param_sets:
        ...
        rlc = RLC_Circuit_Modified(L=L, R=R, C=C, V_in=V_in, t_start=t_span[0], t_end=t_span[1], dt=dt, noise_std=noise_std, q_0=q0,i_0=i0)#(L=L, R=R, C=C, V_in=V_in, q0=q0, i0=i0)
